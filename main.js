...
function openWhatsApp() {
  const phoneNumber = "919911247881"; // Replace with the phone number you want to open chat with
  const message = "Hello, I would like to book..."; // Optional: Pre-filled message
